import os
from .path_and_variables import logger, RULE_FILES
        ...
        try:
            ...
            for line in lines:
                ...
                is_old_dynamic = (
                    ...
                    or (strip_line.startswith("c:\\users\\") and ("\\desktop\\sanctum" in strip_line or "\\appdata\\" in strip_line and "\\sanctum" in strip_line))
                )
