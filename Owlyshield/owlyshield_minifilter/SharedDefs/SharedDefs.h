...
#define OWLY_DYNAMIC_HOOK_RULE_FILE_KERNEL L"\\??\\C:\\Program Files\\HydraDragonAntivirus\\hydradragon\\PYAS_Protection\\PYAS_Protection_Rules\\Owlyshield\\DynamicHook\\default_rules.txt"
// Shared ProcessProtection rule file path (kernel-side exclude list).
#define OWLY_PROCESS_PROTECTION_RULE_FILE_KERNEL L"\\??\\C:\\Program Files\\HydraDragonAntivirus\\hydradragon\\PYAS_Protection\\PYAS_Protection_Rules\\Owlyshield\\ProcessProtection\\default_rules.txt"
// Shared FsFilter rule file path (kernel-side ignore list).
#define OWLY_FSFILTER_RULE_FILE_KERNEL L"\\??\\C:\\Program Files\\HydraDragonAntivirus\\hydradragon\\PYAS_Protection\\PYAS_Protection_Rules\\Owlyshield\\FSFilter\\default_rules.txt"
