...
class GarblerPatternX64(GarblerPattern):
    ...
    def __init__(self, pe_data: bytes = None):
        ...
        if re.search(V21_V23_STACK_EPILOGUE_PATTERN, pe_data) is not None and re.search(V21_V23_SPLIT_EPILOGUE_PATTERN, pe_data) is not None and re.search(V21_V23_SEED_EPILOGUE_PATTERN, pe_data) is not None:
