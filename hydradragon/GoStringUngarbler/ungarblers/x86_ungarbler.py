...
from GoStringUngarbler.patterns import SEED_STRING_DECRYPTION
...
class GoStringUngarblerX86(GoStringUngarbler):
    ...
    def instruction_hook(self, uc: Uc, address: int, size: int, user_data: object) -> None:
        ...
        # Decode once to validate the instruction stream during hook callbacks.
        next(self.capstone.disasm(uc.mem_read(address, size), address))
