...
fr.TelemetryHelp=T�l�m�trie et Assistance
...
fr.Company=Soci�t� :
fr.Country=Pays :
fr.Phone=Num�ro de t�l�phone :
fr.InvalidEmail=Email invalide
fr.DownloadSuccessTo=T�l�chargement r�ussi vers : %s
fr.AbortedByUser=Annul� par l'utilisateur
