    ...
    for i, func in enumerate(ungarbler_instance.decrypt_func_list, start=1):
        try:
            ...
            if decrypted_str:
                ...
                logger.info("%d/%d - Function at 0x%x: %s", i, len(ungarbler_instance.decrypt_func_list), func.func_start_va, repr(decrypted_str))
...
def process_file_go(input_path: str, output_path: Optional[str] = None, string_output_path: Optional[str] = None) -> Dict[str, Any]:
    """
