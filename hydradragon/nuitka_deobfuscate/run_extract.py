...
def extract_blob(
    ...
    if emit_pyc:
        ...
        print("[*] Pass 1: Raw blob scan skipped (emit_pyc=False; focusing on non-.pyc recovery).")
    ...
    return ExtractionResult(pyc_count=count_pyc, raw_scan_hits=len(raw_code_objects), omni_recon_count=sc if OmniDecompiler else 0, metadata_count=count_other, output_dir=out_dir, recovered_files=recovered_file_paths)
