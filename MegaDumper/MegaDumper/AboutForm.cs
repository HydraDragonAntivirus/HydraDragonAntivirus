...
namespace Mega_Dumper
{
    ...
    public partial class AboutForm : Form
    {
        ...
        public static void TryStart(string command)
        {
            ...
            {
                if (command.StartsWith("http://") && ex is System.ComponentModel.Win32Exception)
                {
        ...
        private void LinkSourceforgeLinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
