...
class GoStringUngarbler(ABC):
    ...
    def find_string_decryption_routine(self, decrypt_type: int, garble_pattern: GarblerPattern):
        ...
        for match in string_decrypt_epilogue_pattern.finditer(text_section_data):
            ...
            prologue_matches = garble_pattern.prologue_pattern.findall(text_section_data, pos=last_func_end_offset, endpos=func_end_offset)
            ...
            func_start_relative_offset = text_section_data.rfind(func_prologue_data, last_func_end_offset, func_end_offset)
