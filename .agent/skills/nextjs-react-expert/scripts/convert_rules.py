...
SECTIONS = {
    "async": {"number": 1, "title": "Eliminating Waterfalls", "impact": "CRITICAL", "description": "Waterfalls are the #1 performance killer. Each sequential await adds full network latency. Eliminating them yields the largest gains."},
    "bundle": {"number": 2, "title": "Bundle Size Optimization", "impact": "CRITICAL", "description": "Reducing initial bundle size improves Time to Interactive and Largest Contentful Paint."},
    "server": {"number": 3, "title": "Server-Side Performance", "impact": "HIGH", "description": "Optimizing server-side rendering and data fetching eliminates server-side waterfalls and reduces response times."},
    "client": {"number": 4, "title": "Client-Side Data Fetching", "impact": "MEDIUM-HIGH", "description": "Automatic deduplication and efficient data fetching patterns reduce redundant network requests."},
    "rerender": {"number": 5, "title": "Re-render Optimization", "impact": "MEDIUM", "description": "Reducing unnecessary re-renders minimizes wasted computation and improves UI responsiveness."},
    "rendering": {"number": 6, "title": "Rendering Performance", "impact": "MEDIUM", "description": "Optimizing the rendering process reduces the work the browser needs to do."},
    "js": {"number": 7, "title": "JavaScript Performance", "impact": "LOW-MEDIUM", "description": "Micro-optimizations for hot paths can add up to meaningful improvements."},
    "advanced": {"number": 8, "title": "Advanced Patterns", "impact": "VARIABLE", "description": "Advanced patterns for specific cases that require careful implementation."},
}
