...
class Unprotect:
    ...
    def unprotect(self):
        ...
        result = {"success": False, "version": None, "output_file": None, "file_type": None, "error": None}
...
def unprotect_sourcedefender_file(pye_file: str | Path, key_hex: str = None) -> dict:
    ...
    try:
        ...
        return {"success": False, "error": error_msg, "version": None, "output_file": None, "file_type": None}
...
def get_sourcedefender_info(pye_file: str | Path) -> dict:
    ...
    info = {"file_exists": False, "file_size": 0, "line_count": 0, "derived_key": None, "error": None}
