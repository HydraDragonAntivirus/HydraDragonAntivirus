...
namespace ProcessStatistics
{
    ...
    public class ProcessInfo
    {
        ...
        public ArrayList threadInfoList = new();
    ...
    public static class PStatistics
    {
        [DllImport("ntdll.dll")]
        public static extern NtStatus NtQueryInformationProcess([In] IntPtr ProcessHandle,
            ...
            out VmCounters ProcessInformation,
        ...
        internal static ThreadWaitReason GetThreadWaitReason(int value)
        {
            return value switch
            {
                ...
                0x10 => ThreadWaitReason.LpcReceive,
                0x11 => ThreadWaitReason.LpcReply,
                0x12 => ThreadWaitReason.VirtualMemory,
                0x13 => ThreadWaitReason.PageOut,
        ...
        {
            NtStatus status;
            if ((status = NtQueryInformationProcess(phandle, ProcessInformationClass.ProcessVmCounters, out VmCounters counters, Marshal.SizeOf(typeof(VmCounters)),
                 out _)) >= NtStatus.Error)
        ...
        public static ProcessInfo[] NtGetProcessInfos()
        {
            ...
            try
            {
                ...
                do
                {
                    ...
                    num3 = NtQuerySystemInformation(5, handle.AddrOfPinnedObject(), size, out int returnedSize);
                    if (num3 == -1073741820)
                    {
                ...
                return NtGetProcessInfos(handle.AddrOfPinnedObject());
            }
            finally
            {
                if (handle.IsAllocated)
        ...
        Label_000B:
            ...
            SystemProcessInformation structure = new();
            ...
            {
                SystemThreadInformation information2 = new();
                Marshal.PtrToStructure(ptr, information2);
                ThreadInfo info2 = new()
                {
        ...
        public static ProcessInfo[] OldGetProcessInfos()
        {
            ...
            try
            {
                ...
                HandleRef ref2 = new(null, ptr);
                if (Process32First(ref2, ptr2))
                {
                    do
                    {
                        WinProcessEntry entry = new();
