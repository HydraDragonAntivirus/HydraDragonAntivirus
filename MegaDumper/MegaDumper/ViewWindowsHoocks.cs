...
namespace Mega_Dumper
{
    ...
    public partial class ViewWindowsHoocks : Form
    {
        ...
        private static extern unsafe byte* GetProcAddress(uint hModule, string procName);
        ...
        private unsafe void LogAllHooks()
        {
            ...
            for (i = 0; i < HandleEntries; i++)
            {
                ...
                if (hook[8] == 5) // if _HANDLE_ENTRY.Type is TYPE_HOOK
                {
                    try
                    {
                        ...
                        hoocktext = hooktype <= 14
                            ? hoocktext + "HookType: " + ((HookType)hooktype).ToString() +
                        ...
                        if ((flagsv & 2) != 0)  // G_HOOK_FLAG_IN_CALL = 2
                        {
                            ...
                            flagsstring += "G_HOOK_FLAG_IN_CALL";
                        }
                        /*
        ...
        private void ViewWindowsHoocksShown(object sender, EventArgs e)
        {
            LogAllHooks();
        }
    }
