...
///
/// Service that receives raw events from the configured network telemetry source.
///
...
private:
	...
	void notifyNewConnectionInfo(std::shared_ptr<const ConnectionInfo> pConInfo) override;
