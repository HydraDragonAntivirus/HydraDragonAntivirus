...
enum class Event : uint64_t
{
	...
	// Kernel hook/hypervisor event carrier (DeviceIoControl LBVS path)
	LLE_DEVICE_IOCTL				= 0x000000000000002FL,
	LLE_SELF_DEFENSE				= 0x0000000000000030L,
	LLE_NAMED_PIPE_CREATE			= 0x0000000000000031L,
	LLE_FILE_RENAME					= 0x0000000000000032L,
	LLE_THREAD_OPEN					= 0x0000000000000033L,
	LLE_FILE_MAP_READ				= 0x0000000000000034L,
	LLE_FILE_MAP_WRITE				= 0x0000000000000035L,
	LLE_FILE_HANDLE_OPEN			= 0x0000000000000036L,
