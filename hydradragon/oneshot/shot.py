...
async def process_file_python(path: str, data: bytes, runtime: RuntimeInfo, output_dir: str = None, export_raw: bool = True):
    """
    ...
    try:
        ...
        if int.from_bytes(data[20:24], "little") == 9:
            ...
            bcc_aes_decrypted = general_aes_ctr_decrypt(data[cipher_text_offset : cipher_text_offset + cipher_text_length], runtime.runtime_aes_key, nonce)
        ...
        cipher_text_length = int.from_bytes(data[32:36], "little")
        nonce = data[36:40] + data[44:52]
        decrypted = general_aes_ctr_decrypt(data[cipher_text_offset : cipher_text_offset + cipher_text_length], runtime.runtime_aes_key, nonce)
...
async def decrypt_all_python(runtimes: Dict[str, RuntimeInfo], sequences: List[Tuple[str, bytes]], output_dir: str = None, concurrent: int = 4):
    """
