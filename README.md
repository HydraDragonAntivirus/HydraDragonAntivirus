...
**Note 10:**
- I added en_core_web_md manually to C:\Program Files\HydraDragonAntivirus you can find the spacy path from codechecker\spacyfind.py
...
- Sometimes you have to wait 30+ minutes (it can go up to 2 hours) when you run the program for the first time because a lot of things are loading, but generally this only happens to me because on other computers it's much faster, even if my best laptop causes this problem, other computers are generally faster at running modules etc.
