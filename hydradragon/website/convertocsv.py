...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Convert a .txt list to a .csv file with an "Unknown" reference column.', formatter_class=argparse.RawTextHelpFormatter)
