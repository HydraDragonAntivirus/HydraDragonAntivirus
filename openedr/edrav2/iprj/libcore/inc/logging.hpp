...
// Logging functions from the hook bridge
#ifdef __cplusplus
extern "C" {
#endif
	void logHookBridgeError(const wchar_t* sMsg);
	void logHookBridgeWarning(const wchar_t* sMsg);
	void logHookBridgeInfo(const wchar_t* sMsg);
#ifdef __cplusplus
} // extern "C" 
#endif
/// @}
