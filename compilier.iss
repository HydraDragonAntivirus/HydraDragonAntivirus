...
[Components]
Name: "hydradragon"; Description: "HydraDragon Antivirus"; Types: full custom compact; Flags: fixed
Name: "owlyshield"; Description: "Owlyshield Ransom Protection"; Types: full custom
...
[Dirs]
Name: "{app}\debug"; Components: owlyshield
Name: "{app}\utils"; Components: owlyshield
Name: "{app}\log"; Flags: uninsneveruninstall; Components: owlyshield
Name: "{app}\config"; Flags: uninsneveruninstall; Components: owlyshield
Name: "{app}\config\threats"; Flags: uninsneveruninstall; Components: owlyshield
...
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "NUM_VERSION"; ValueData: {#OwlyshieldVersion}; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "PROCESS_ACTIVITY_PATH"; ValueData: "{app}\debug"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "UTILS_PATH"; ValueData: "{app}\utils"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "CONFIG_PATH"; ValueData: "{app}\config"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "LOG_PATH"; ValueData: "{app}\log"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "APP_ID"; ValueData: "8C19967B-1D27-4E6A-85CD-5059912C2788"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "LANGUAGE"; ValueData: "en-US"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "KILL_POLICY"; ValueData: "DO_NOTHING"; Flags: uninsdeletekey; Components: owlyshield
Root: HKLM64; Subkey: "Software\Owlyshield"; ValueType: string; ValueName: "TELEMETRY"; ValueData: 0; Flags: uninsdeletekey; Components: owlyshield
...
; Custom setup script (includes bcdedit testsigning)
Filename: "{tmp}\setup.bat"; Flags: shellexec waituntilterminated

; Owlyshield specific installations (only if Owlyshield component is selected)
Filename: "RUNDLL32.EXE"; Parameters: "SETUPAPI.DLL,InstallHinfSection DefaultInstall 132 {app}\{#FsFilter}\{#FsFilter}.inf"; Flags: runhidden; Components: owlyshield
...
Filename: "sc.exe"; Parameters: "stop ""{#AgentName}"""; Components: owlyshield
Filename: "sc.exe"; Parameters: "stop ""{#FsFilter}"""; Components: owlyshield
Filename: "sc.exe"; Parameters: "delete ""{#AgentName}"""; Components: owlyshield
Filename: "sc.exe"; Parameters: "delete ""{#FsFilter}"""; Components: owlyshield
Filename: "del.exe"; Parameters: """C:\Windows\System32\drivers\{#FsFilter}.sys"""; Components: owlyshield