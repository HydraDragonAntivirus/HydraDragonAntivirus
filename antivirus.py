...
malware_domains_mail_path = os.path.join(script_dir, "website", "MalwareDomainsMail.txt")
...
mining_domains_path = os.path.join(script_dir, "website", "MiningDomains.txt")
spam_domains_path = os.path.join(script_dir, "website", "SpamDomains.txt")
whitelist_domains_path = os.path.join(script_dir, "website", "WhiteListDomains.txt")
whitelist_domains_mail_path = os.path.join(script_dir, "website", "WhiteListDomainsMail.txt")
