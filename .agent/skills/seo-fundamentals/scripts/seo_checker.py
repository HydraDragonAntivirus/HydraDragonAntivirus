...
# Directories to skip
SKIP_DIRS = {"node_modules", ".next", "dist", "build", ".git", ".github", "__pycache__", ".vscode", ".idea", "coverage", "test", "tests", "__tests__", "spec", "docs", "documentation", "examples"}

# Files to skip (not pages)
SKIP_PATTERNS = ["config", "setup", "util", "helper", "hook", "context", "store", "service", "api", "lib", "constant", "type", "interface", "mock", ".test.", ".spec.", "_test.", "_spec."]
...
def is_page_file(file_path: Path) -> bool:
    ...
    page_names = ["page", "index", "home", "about", "contact", "blog", "post", "article", "product", "landing", "layout"]
...
def main():
    ...
    output = {"script": "seo_checker", "project": str(project_path), "files_checked": len(pages), "files_with_issues": len(all_issues), "issues_found": total_issues, "passed": passed}
