...
Now also tracks malicious file hashes with their associated virus names.
"""
...
def _add_malicious_hash(file_hash: str, virus_name: str):
    """Add a malicious file hash with its associated virus name to the global tracking dict."""
    if file_hash:
        with malicious_hashes_lock:
            malicious_hashes[file_hash] = virus_name
            logger.info(f"Added malicious hash: {file_hash[:16]}... -> {virus_name}")


# --- Notification Functions (Now with EDR Integration, main_file_path, and hash tracking) ---

def notify_user(file_path, virus_name, engine_detected, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
    ...
    _add_malicious_hash(file_hash, virus_name)
    _send_to_edr(file_path, virus_name, action="kill_and_remove", main_file_path=main_file_path)


def notify_user_pua(file_path, virus_name, engine_detected, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_for_malicious_source_code(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_size_warning(file_path, archive_type, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_susp_archive_file_name_warning(file_path, archive_type, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_susp_name(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_scr(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_for_detected_fake_system_file(file_path, file_name, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_invalid(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_fake_size(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_startup(file_path, message, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_exela_stealer_v2(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_hosts(file_path, virus_name, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
...
def notify_user_for_web(domain=None, ipv4_address=None, ipv6_address=None, url=None, file_path=None, detection_type=None, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
    ...
    if file_path:
        ...
        _add_malicious_hash(file_hash, threat_name)
...
def notify_user_for_detected_hips_file(file_path, src_ip, alert_line, status, file_hash: Optional[str] = None, main_file_path: Optional[str] = None):
    notification = Notify()
