...
def check_hardcoded_strings(project_path: Path) -> dict:
    ...
    # Find code files
    extensions = {".tsx": "jsx", ".jsx": "jsx", ".ts": "jsx", ".js": "jsx", ".vue": "vue", ".py": "python"}

    code_files = []
    for ext in extensions:
        code_files.extend(project_path.rglob(f"*{ext}"))

    code_files = [f for f in code_files if not any(x in str(f) for x in ["node_modules", ".git", "dist", "build", "__pycache__", "venv", "test", "spec"])]
