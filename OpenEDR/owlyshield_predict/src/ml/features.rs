...
pub struct PeFeatureVector {
    ...
    pub image_base: f32,
    pub section_alignment: f32,
    pub file_alignment: f32,
    pub major_operating_system_version: f32,
    pub minor_operating_system_version: f32,
    pub major_image_version: f32,
    pub minor_image_version: f32,
    pub major_subsystem_version: f32,
    pub minor_subsystem_version: f32,
    pub size_of_image: f32,
    pub size_of_headers: f32,
    pub checksum: f32,
    pub subsystem: f32,
    pub dll_characteristics: f32,
    pub size_of_stack_reserve: f32,
    pub size_of_stack_commit: f32,
    pub size_of_heap_reserve: f32,
    pub size_of_heap_commit: f32,
    pub loader_flags: f32,
    pub number_of_rva_and_sizes: f32,
    pub export_table_size: f32,
    pub import_table_size: f32,
    pub resource_table_size: f32,
    pub exception_table_size: f32,
    pub certificate_table_size: f32,
    pub base_relocation_table_size: f32,
    pub debug_table_size: f32,
    pub tls_table_size: f32,
    pub load_config_table_size: f32,
    pub bound_import_table_size: f32,
    pub iat_table_size: f32,
    pub delay_import_table_size: f32,
    pub clr_runtime_header_size: f32,
...
impl PeFeatureVector {
    ...
    pub fn to_array(&self) -> [f32; 65] {
        [
            self.size_of_optional_header,
            self.coff_characteristics,
            self.machine,
            ...
            self.export_table_size,
            self.import_table_size,
            self.resource_table_size,
            self.exception_table_size,
            self.certificate_table_size,
            self.base_relocation_table_size,
            self.debug_table_size,
            self.tls_table_size,
            self.load_config_table_size,
            self.bound_import_table_size,
            self.iat_table_size,
            self.delay_import_table_size,
            self.clr_runtime_header_size,
            self.imports_count,
            self.exports_count,
    ...
    pub fn to_map(&self) -> HashMap<String, f32> {
        [
            ...
            ("export_table_size", self.export_table_size),
            ("import_table_size", self.import_table_size),
            ("resource_table_size", self.resource_table_size),
            ("exception_table_size", self.exception_table_size),
            ("certificate_table_size", self.certificate_table_size),
            (
                "base_relocation_table_size",
                self.base_relocation_table_size,
            ),
            ("debug_table_size", self.debug_table_size),
            ("tls_table_size", self.tls_table_size),
            ("load_config_table_size", self.load_config_table_size),
            ("bound_import_table_size", self.bound_import_table_size),
            ("iat_table_size", self.iat_table_size),
            ("delay_import_table_size", self.delay_import_table_size),
            ("clr_runtime_header_size", self.clr_runtime_header_size),
...
mod tests {
    ...
    fn pe_to_map_covers_all_features() {
        let f = PeFeatureVector {
            ...
            coff_characteristics: 2.0,
            machine: 3.0,
            major_linker_version: 4.0,
            minor_linker_version: 5.0,
            size_of_code: 6.0,
            size_of_initialized_data: 7.0,
            size_of_uninitialized_data: 8.0,
            address_of_entry_point: 9.0,
            image_base: 10.0,
            section_alignment: 11.0,
            file_alignment: 12.0,
            major_operating_system_version: 13.0,
            minor_operating_system_version: 14.0,
            major_image_version: 15.0,
            minor_image_version: 16.0,
            major_subsystem_version: 17.0,
            minor_subsystem_version: 18.0,
            size_of_image: 19.0,
            size_of_headers: 20.0,
            checksum: 21.0,
            subsystem: 22.0,
            dll_characteristics: 23.0,
            size_of_stack_reserve: 24.0,
            size_of_stack_commit: 25.0,
            size_of_heap_reserve: 26.0,
            size_of_heap_commit: 27.0,
            loader_flags: 28.0,
            number_of_rva_and_sizes: 29.0,
            export_table_size: 30.0,
            import_table_size: 31.0,
            resource_table_size: 32.0,
            exception_table_size: 33.0,
            certificate_table_size: 34.0,
            base_relocation_table_size: 35.0,
            debug_table_size: 36.0,
            tls_table_size: 37.0,
            load_config_table_size: 38.0,
            bound_import_table_size: 39.0,
            iat_table_size: 40.0,
            delay_import_table_size: 41.0,
            clr_runtime_header_size: 42.0,
            imports_count: 43.0,
            exports_count: 44.0,
            resources_count: 45.0,
            sections_count: 46.0,
            overlay_exists: 47.0,
            overlay_size: 48.0,
            sec_entropy_mean: 49.0,
            sec_entropy_min: 50.0,
            sec_entropy_max: 51.0,
            total_instructions: 52.0,
            total_add_instructions: 53.0,
            total_mov_instructions: 54.0,
            is_likely_packed: 55.0,
            add_mov_ratio: 56.0,
            instructions_per_kb: 57.0,
            num_tls_callbacks: 58.0,
            num_delay_imports: 59.0,
            num_reloc_entries: 60.0,
            num_reloc_blocks: 61.0,
            num_bound_imports: 62.0,
            num_debug_entries: 63.0,
            cert_size: 64.0,
            has_rich_header: 65.0,
        };
        let map = f.to_map();
        assert_eq!(map.len(), PeFeatureVector::LEN);
        assert_eq!(map["sec_entropy_mean"], 49.0);
        assert_eq!(map["is_likely_packed"], 55.0);
        assert_eq!(map["has_rich_header"], 65.0);
    }
