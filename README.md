...
Dynamic and Static Analysis with Sandboxie for Windows, featuring ClamAV, YARA-X, my machine learning AI module, and Snort.
...
## Guide
**Notice:** You must create a DefaultBox in Sandboxie by running it once with a random application. Also, please clean the `C:\Sandbox` folder items.
...
- I don't usually encounter this problem, but I did with CollabVM.
