...
; .NET Desktop Runtime 8.0.17 (silent, no restart)
Filename: "{tmp}\windowsdesktop-runtime-8.0.17-win-x64.exe"; Parameters: "/install /quiet /norestart"; Flags: shellexec waituntilterminated
