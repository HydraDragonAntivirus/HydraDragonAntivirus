...
enum IRP_MAJOR_OP
{
    ...
    // Collapsed kernel telemetry opcodes:
    // 13 -> generic API, 14 -> generic assembly-level behavior.
    IRP_NT_GENERIC_API_CALL,
    IRP_NT_GENERIC_ASSEMBLY_EVENT,
};

// Backward-compatible aliases: old detailed 13-24 event names now map to
// one of the two generic telemetry buckets.
#define IRP_NT_WRITE_VIRTUAL_MEMORY IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_ALLOCATE_VIRTUAL_MEMORY IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_PROTECT_VIRTUAL_MEMORY IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_CREATE_THREAD IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_QUEUE_APC IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_SET_CONTEXT IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_CREATE_SECTION IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_MAP_SECTION IRP_NT_GENERIC_ASSEMBLY_EVENT
#define IRP_NT_DELETE_FILE IRP_NT_GENERIC_API_CALL
#define IRP_NT_LOAD_DRIVER IRP_NT_GENERIC_API_CALL
#define IRP_NT_OPEN_PROCESS IRP_NT_GENERIC_API_CALL
...
// Generic telemetry opcodes:
// IRP_NT_GENERIC_API_CALL == 13, IRP_NT_GENERIC_ASSEMBLY_EVENT == 14
