...
namespace Mega_Dumper
{
    ...
    public partial class VirtualMemoryView : Form
    {
        ...
        public struct MemoryBasicInformation64
        {
            ...
            public IntPtr AllocationBase;
            public MemoryProtection AllocationProtect;
            private readonly int _alignment1;
            public ulong RegionSize;
            public MemoryState State;
            public MemoryProtection Protect;
            public MemoryType Type;
            private readonly int _alignment2;
        }
        ...
        private void VirtualMemoryViewShown(object sender, EventArgs e)
        {
            Text = "Virtual memory for " + processname + " whit PID=" + procid.ToString();
